...
export const SUMMARYSECTIONS: SummarySection[] = [
  ...
  {carouselImageSource: '/assets/images/Teacher.jpg', headingString: 'About Myself', bodyRoute: 'aboutMe', bodyComponent: AboutMeComponent},
  {carouselImageSource: '/assets/images/Vouch.jpg', headingString: 'Testamonials', bodyRoute: 'testamonials',
